...
DEBUG = os.environ.get('DEBUG', 'True').lower() == 'true'  # Set to True temporarily!

# ALLOWED_HOSTS for Railway
ALLOWED_HOSTS = ['*']  # Use wildcard temporarily to debug

# Add Railway domains
ALLOWED_HOSTS.extend(['.railway.app', 'hadsxk-production.up.railway.app'])
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # ← CRITICAL FIX!
