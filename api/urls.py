...
urlpatterns = [
    ...
    path('generate-image/', views.generate_image, name='generate_ai_image'),  # Updated view name
    path('ai-generate-image/', views.generate_image, name='ai_generate_image'),  # Alternative endpoint
